...
begin
  ...
  ('Grupos', 'A', '2026-06-11 15:00:00', 'México', 'Sudáfrica', 'MX', 'ZA', 'Estadio Azteca', 'Ciudad de México'),
  ('Grupos', 'A', '2026-06-11 22:00:00', 'República de Corea', 'Chequia', 'KR', 'CZ', 'Estadio Akron', 'Guadalajara'),
  ('Grupos', 'B', '2026-06-12 15:00:00', 'Canadá', 'Bosnia y Herzegovina', 'CA', 'BA', 'BMO Field', 'Toronto'),
  ('Grupos', 'D', '2026-06-12 21:00:00', 'Estados Unidos', 'Paraguay', 'US', 'PY', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Grupos', 'B', '2026-06-13 15:00:00', 'Catar', 'Suiza', 'QA', 'CH', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Grupos', 'C', '2026-06-13 18:00:00', 'Brasil', 'Marruecos', 'BR', 'MA', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Grupos', 'C', '2026-06-13 21:00:00', 'Haití', 'Escocia', 'HT', 'GB-SCT', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Grupos', 'D', '2026-06-14 12:00:00', 'Australia', 'Turquía', 'AU', 'TR', 'BC Place', 'Vancouver'),
  ('Grupos', 'E', '2026-06-14 13:00:00', 'Alemania', 'Curazao', 'DE', 'CW', 'NRG Stadium', 'Houston'),
  ('Grupos', 'F', '2026-06-14 16:00:00', 'Países Bajos', 'Japón', 'NL', 'JP', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Grupos', 'E', '2026-06-14 19:00:00', 'Costa de Marfil', 'Ecuador', 'CI', 'EC', 'Lincoln Financial Field', 'Filadelfia'),
  ('Grupos', 'F', '2026-06-14 22:00:00', 'Suecia', 'Túnez', 'SE', 'TN', 'Estadio BBVA', 'Monterrey'),
  ('Grupos', 'H', '2026-06-15 12:00:00', 'España', 'Cabo Verde', 'ES', 'CV', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Grupos', 'G', '2026-06-15 15:00:00', 'Bélgica', 'Egipto', 'BE', 'EG', 'Lumen Field', 'Seattle'),
  ('Grupos', 'H', '2026-06-15 18:00:00', 'Arabia Saudí', 'Uruguay', 'SA', 'UY', 'Hard Rock Stadium', 'Miami'),
  ('Grupos', 'G', '2026-06-15 21:00:00', 'RI de Irán', 'Nueva Zelanda', 'IR', 'NZ', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Grupos', 'I', '2026-06-16 15:00:00', 'Francia', 'Senegal', 'FR', 'SN', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Grupos', 'I', '2026-06-16 18:00:00', 'Irak', 'Noruega', 'IQ', 'NO', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Grupos', 'J', '2026-06-16 21:00:00', 'Argentina', 'Argelia', 'AR', 'DZ', 'Arrowhead Stadium', 'Kansas City'),
  ('Grupos', 'J', '2026-06-17 00:00:00', 'Austria', 'Jordania', 'AT', 'JO', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Grupos', 'K', '2026-06-17 13:00:00', 'Portugal', 'RD Congo', 'PT', 'CD', 'NRG Stadium', 'Houston'),
  ('Grupos', 'L', '2026-06-17 16:00:00', 'Inglaterra', 'Croacia', 'GB-ENG', 'HR', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Grupos', 'L', '2026-06-17 19:00:00', 'Ghana', 'Panamá', 'GH', 'PA', 'BMO Field', 'Toronto'),
  ('Grupos', 'K', '2026-06-17 22:00:00', 'Uzbekistán', 'Colombia', 'UZ', 'CO', 'Estadio Azteca', 'Ciudad de México'),
  ('Grupos', 'A', '2026-06-18 12:00:00', 'Chequia', 'Sudáfrica', 'CZ', 'ZA', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Grupos', 'B', '2026-06-18 15:00:00', 'Suiza', 'Bosnia y Herzegovina', 'CH', 'BA', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Grupos', 'B', '2026-06-18 18:00:00', 'Canadá', 'Catar', 'CA', 'QA', 'BC Place', 'Vancouver'),
  ('Grupos', 'A', '2026-06-18 21:00:00', 'México', 'República de Corea', 'MX', 'KR', 'Estadio Akron', 'Guadalajara'),
  ('Grupos', 'D', '2026-06-19 15:00:00', 'Estados Unidos', 'Australia', 'US', 'AU', 'Lumen Field', 'Seattle'),
  ('Grupos', 'C', '2026-06-19 18:00:00', 'Escocia', 'Marruecos', 'GB-SCT', 'MA', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Grupos', 'C', '2026-06-19 20:30:00', 'Brasil', 'Haití', 'BR', 'HT', 'Lincoln Financial Field', 'Filadelfia'),
  ('Grupos', 'D', '2026-06-19 23:00:00', 'Turquía', 'Paraguay', 'TR', 'PY', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Grupos', 'F', '2026-06-20 13:00:00', 'Países Bajos', 'Suecia', 'NL', 'SE', 'NRG Stadium', 'Houston'),
  ('Grupos', 'E', '2026-06-20 16:00:00', 'Alemania', 'Costa de Marfil', 'DE', 'CI', 'BMO Field', 'Toronto'),
  ('Grupos', 'E', '2026-06-20 20:00:00', 'Ecuador', 'Curazao', 'EC', 'CW', 'Arrowhead Stadium', 'Kansas City'),
  ('Grupos', 'F', '2026-06-21 00:00:00', 'Túnez', 'Japón', 'TN', 'JP', 'Estadio BBVA', 'Monterrey'),
  ('Grupos', 'H', '2026-06-21 12:00:00', 'España', 'Arabia Saudí', 'ES', 'SA', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Grupos', 'G', '2026-06-21 15:00:00', 'Bélgica', 'RI de Irán', 'BE', 'IR', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Grupos', 'H', '2026-06-21 18:00:00', 'Uruguay', 'Cabo Verde', 'UY', 'CV', 'Hard Rock Stadium', 'Miami'),
  ('Grupos', 'G', '2026-06-21 21:00:00', 'Nueva Zelanda', 'Egipto', 'NZ', 'EG', 'BC Place', 'Vancouver'),
  ('Grupos', 'J', '2026-06-22 13:00:00', 'Argentina', 'Austria', 'AR', 'AT', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Grupos', 'I', '2026-06-22 17:00:00', 'Francia', 'Irak', 'FR', 'IQ', 'Lincoln Financial Field', 'Filadelfia'),
  ('Grupos', 'I', '2026-06-22 20:00:00', 'Noruega', 'Senegal', 'NO', 'SN', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Grupos', 'J', '2026-06-22 23:00:00', 'Jordania', 'Argelia', 'JO', 'DZ', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Grupos', 'K', '2026-06-23 13:00:00', 'Portugal', 'Uzbekistán', 'PT', 'UZ', 'NRG Stadium', 'Houston'),
  ('Grupos', 'L', '2026-06-23 16:00:00', 'Inglaterra', 'Ghana', 'GB-ENG', 'GH', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Grupos', 'L', '2026-06-23 19:00:00', 'Panamá', 'Croacia', 'PA', 'HR', 'BMO Field', 'Toronto'),
  ('Grupos', 'K', '2026-06-23 22:00:00', 'Colombia', 'RD Congo', 'CO', 'CD', 'Estadio Akron', 'Guadalajara'),
  ('Grupos', 'B', '2026-06-24 15:00:00', 'Suiza', 'Canadá', 'CH', 'CA', 'BC Place', 'Vancouver'),
  ('Grupos', 'B', '2026-06-24 15:00:00', 'Bosnia y Herzegovina', 'Catar', 'BA', 'QA', 'Lumen Field', 'Seattle'),
  ('Grupos', 'C', '2026-06-24 18:00:00', 'Escocia', 'Brasil', 'GB-SCT', 'BR', 'Hard Rock Stadium', 'Miami'),
  ('Grupos', 'C', '2026-06-24 18:00:00', 'Marruecos', 'Haití', 'MA', 'HT', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Grupos', 'A', '2026-06-24 21:00:00', 'Chequia', 'México', 'CZ', 'MX', 'Estadio Azteca', 'Ciudad de México'),
  ('Grupos', 'A', '2026-06-24 21:00:00', 'Sudáfrica', 'República de Corea', 'ZA', 'KR', 'Estadio BBVA', 'Monterrey'),
  ('Grupos', 'E', '2026-06-25 16:00:00', 'Curazao', 'Costa de Marfil', 'CW', 'CI', 'Lincoln Financial Field', 'Filadelfia'),
  ('Grupos', 'E', '2026-06-25 16:00:00', 'Ecuador', 'Alemania', 'EC', 'DE', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Grupos', 'F', '2026-06-25 19:00:00', 'Japón', 'Suecia', 'JP', 'SE', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Grupos', 'F', '2026-06-25 19:00:00', 'Túnez', 'Países Bajos', 'TN', 'NL', 'Arrowhead Stadium', 'Kansas City'),
  ('Grupos', 'D', '2026-06-25 22:00:00', 'Turquía', 'Estados Unidos', 'TR', 'US', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Grupos', 'D', '2026-06-25 22:00:00', 'Paraguay', 'Australia', 'PY', 'AU', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Grupos', 'I', '2026-06-26 15:00:00', 'Noruega', 'Francia', 'NO', 'FR', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Grupos', 'I', '2026-06-26 15:00:00', 'Senegal', 'Irak', 'SN', 'IQ', 'BMO Field', 'Toronto'),
  ('Grupos', 'H', '2026-06-26 20:00:00', 'Cabo Verde', 'Arabia Saudí', 'CV', 'SA', 'NRG Stadium', 'Houston'),
  ('Grupos', 'H', '2026-06-26 20:00:00', 'Uruguay', 'España', 'UY', 'ES', 'Estadio Akron', 'Guadalajara'),
  ('Grupos', 'G', '2026-06-26 23:00:00', 'Egipto', 'RI de Irán', 'EG', 'IR', 'Lumen Field', 'Seattle'),
  ('Grupos', 'G', '2026-06-26 23:00:00', 'Nueva Zelanda', 'Bélgica', 'NZ', 'BE', 'BC Place', 'Vancouver'),
  ('Grupos', 'L', '2026-06-27 17:00:00', 'Panamá', 'Inglaterra', 'PA', 'GB-ENG', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Grupos', 'L', '2026-06-27 17:00:00', 'Croacia', 'Ghana', 'HR', 'GH', 'Lincoln Financial Field', 'Filadelfia'),
  ('Grupos', 'K', '2026-06-27 19:30:00', 'Colombia', 'Portugal', 'CO', 'PT', 'Hard Rock Stadium', 'Miami'),
  ('Grupos', 'K', '2026-06-27 19:30:00', 'RD Congo', 'Uzbekistán', 'CD', 'UZ', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Grupos', 'J', '2026-06-27 22:00:00', 'Argelia', 'Austria', 'DZ', 'AT', 'Arrowhead Stadium', 'Kansas City'),
  ('Grupos', 'J', '2026-06-27 22:00:00', 'Jordania', 'Argentina', 'JO', 'AR', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Dieciseisavos', NULL, '2026-06-28 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Dieciseisavos', NULL, '2026-06-29 13:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'NRG Stadium', 'Houston'),
  ('Dieciseisavos', NULL, '2026-06-29 16:30:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Dieciseisavos', NULL, '2026-06-29 21:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Estadio BBVA', 'Monterrey'),
  ('Dieciseisavos', NULL, '2026-06-30 13:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Dieciseisavos', NULL, '2026-06-30 17:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Dieciseisavos', NULL, '2026-06-30 21:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Estadio Azteca', 'Ciudad de México'),
  ('Dieciseisavos', NULL, '2026-07-01 12:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Dieciseisavos', NULL, '2026-07-01 16:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Lumen Field', 'Seattle'),
  ('Dieciseisavos', NULL, '2026-07-01 20:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Levi''s Stadium', 'San Francisco (Santa Clara)'),
  ('Dieciseisavos', NULL, '2026-07-02 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Dieciseisavos', NULL, '2026-07-02 19:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'BMO Field', 'Toronto'),
  ('Dieciseisavos', NULL, '2026-07-02 23:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'BC Place', 'Vancouver'),
  ('Dieciseisavos', NULL, '2026-07-03 14:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Dieciseisavos', NULL, '2026-07-03 18:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Hard Rock Stadium', 'Miami'),
  ('Dieciseisavos', NULL, '2026-07-03 21:30:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Arrowhead Stadium', 'Kansas City'),
  ('Octavos', NULL, '2026-07-04 13:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'NRG Stadium', 'Houston'),
  ('Octavos', NULL, '2026-07-04 17:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Lincoln Financial Field', 'Filadelfia'),
  ('Octavos', NULL, '2026-07-05 16:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'MetLife Stadium', 'Nueva York (East Rutherford)'),
  ('Octavos', NULL, '2026-07-05 20:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Estadio Azteca', 'Ciudad de México'),
  ('Octavos', NULL, '2026-07-06 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Octavos', NULL, '2026-07-06 20:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Lumen Field', 'Seattle'),
  ('Octavos', NULL, '2026-07-07 12:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Octavos', NULL, '2026-07-07 16:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'BC Place', 'Vancouver'),
  ('Cuartos', NULL, '2026-07-09 16:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Gillette Stadium', 'Boston (Foxborough)'),
  ('Cuartos', NULL, '2026-07-10 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'SoFi Stadium', 'Los Ángeles (Inglewood)'),
  ('Cuartos', NULL, '2026-07-11 17:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Hard Rock Stadium', 'Miami'),
  ('Cuartos', NULL, '2026-07-11 21:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Arrowhead Stadium', 'Kansas City'),
  ('Semifinales', NULL, '2026-07-14 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'AT&T Stadium', 'Dallas (Arlington)'),
  ('Semifinales', NULL, '2026-07-15 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Mercedes-Benz Stadium', 'Atlanta'),
  ('Tercer Puesto', NULL, '2026-07-18 17:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'Hard Rock Stadium', 'Miami'),
  ('Final', NULL, '2026-07-19 15:00:00', 'Por definir', 'Por definir', 'XX', 'XX', 'MetLife Stadium', 'Nueva York (East Rutherford)');
  end if;
end $$;
