...
export const APP_VERSION = "2026.07.07-4 (Iconos: nuevo balon (Tabler ball-football con pentagono + rayos) y nuevo botin (silueta lateral con 5 tapones). Se propagan a Timeline, Cancha, Estadisticas y Admin.)";
